...
namespace SHMS
{
    public partial class Form14 : Form
    {
        ...
        void BindData()
        {
            ...
            SqlCommand cmd1 = new SqlCommand("SELECT * FROM recuser", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text == "")
            {
                MessageBox.Show("Please enter a receptionist id for remove.", "Required", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            else
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE recinfo WHERE ID=@ID", con);
                    SqlCommand cmd1 = new SqlCommand("DELETE recuser WHERE ID=@ID", con);
                ...
                {
                    MessageBox.Show("Receptionist NOT Exists.");
                }
            }
        }
        ...
        private void Form14_Load(object sender, EventArgs e)
        {
            ...
            //con.Open();
            SqlCommand cmd1 = new SqlCommand("SELECT * FROM recuser order by ID", con);
            SqlDataAdapter da1 = new SqlDataAdapter(cmd1);
            DataTable dt1 = new DataTable();
            dt1.Clear();
            da1.Fill(dt1);
