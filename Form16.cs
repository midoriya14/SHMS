...
namespace SHMS
{
    public partial class Form16 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text == "")
            {
                MessageBox.Show("Please enter a receptionist id for search.", "Required", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            ...
            else
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    SqlCommand cmd1 = new SqlCommand("SELECT * FROM recuser WHERE ID=@ID", con);
